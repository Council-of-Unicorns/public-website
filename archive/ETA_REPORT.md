...
**We expect 2.0× over Jetson Thor at first silicon and 2.9× once the compiler matures, at
equal 40 W head power** — with a defensible pessimistic case of 1.6×, a mature band of
2.0–4.0×, and a ceiling near 7×. The bar is 2.15× and the design target is 3.0×. The same
