...
| Frontier | ~8× [T] | 6.0–9.7× [T] | model resident in hybrid-bonded stacked DRAM (reads ~40 → ~8 pJ/B); 8–16 GB over 100–200 MB distributed SRAM; bank-local compute deleting the central PHY/controller; moves the memory roofline |
